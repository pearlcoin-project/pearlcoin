...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s pearlcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  pearlcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded pearlcoin transaction") + "\n" +
              "  pearlcoin-tx [options] -create [commands]   " + _("Create hex-encoded pearlcoin transaction") + "\n" +
              "\n";
