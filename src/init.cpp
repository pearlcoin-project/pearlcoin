...
void Shutdown()
{
    ...
    RenameThread("pearlcoin-shutoff");
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/pearlcoin-project/pearlcoin>";
    const std::string URL_WEBSITE = "<https://pearlcoin.org>";
...
void ThreadImport(std::vector<boost::filesystem::path> vImportFiles)
{
    ...
    RenameThread("pearlcoin-loadblk");
    CImportingNow imp;
