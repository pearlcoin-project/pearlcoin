...
#if defined(NDEBUG)
# error "Pearlcoin cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Pearlcoin Signed Message:\n";
...
void ThreadScriptCheck() {
    RenameThread("pearlcoin-scriptch");
...
bool ContextualCheckBlockHeader(const CBlockHeader& block, CValidationState& state, const Consensus::Params& consensusParams, CBlockIndex * const pindexPrev, int64_t nAdjustedTime)
{
    ...
    // Pearlcoin: Reject block.nVersion=1 blocks (mainnet >= 710000, testnet >= 400000, regtest uses supermajority)
...
bool ContextualCheckBlock(const CBlock& block, CValidationState& state, CBlockIndex * const pindexPrev)
{
    ...
    // Pearlcoin: (mainnet >= 710000, testnet >= 400000, regtest uses supermajority)
